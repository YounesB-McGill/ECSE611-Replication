...
def aggregate(folder, name, outFile):
    ...
    print("\n")
    ecosystem = name.split("_")[0]
    project = name.split("_")[1]
    ...
    with open(folder + "/" + CONSTS.PUPPETEER_OUT_FILE, 'rt', errors='ignore') as curFile:
        for line in curFile:
            ...
            if ".pp" in line:
                info = line.split("/")
                # print("info: ", info)
                filename = info[-1].replace("\n","").strip()
                commit = info[len(info)-2].replace("\n","").strip()
                # print("line: ", line)
                ...
                outFile.write(ecosystem + "," + project + "," + filename + "," + commit + "," + str(fileCount) + "," + str(classCount) + "," + str(defineCount) + "," + str(fileResourceCount) + "," + str(packageCount) + "," + str(serviceCount) + "," + str(execCount) + "," + str(LOCCount) + "," + str(multiAbsSmellCount) + "," + str(unnAbsSmellCount) + "," + str(impAbsSmellCount) + "," + str(misAbsSmellCount) + "," + str(insModSmellCount) + "," + str(unsModSmellCount) + "," + str(tcModSmellCount) + "," + str(dupAbsSmellCount) + "," + str(misDepSmellCount) + ',' + str(broHieSmellCount) + "," + str(haiStrSmellCount) + "," + str(defEncSmellCount) + "," + str(weaModSmellCount))
